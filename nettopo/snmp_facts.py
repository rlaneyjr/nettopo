...
class SnmpFacts:
    ...
    def get_facts(self):
        ...
        gen_facts_mibs = [cmdgen.MibVariable(x,) for x in v.general_mibs]
        ...
        int_facts_mibs = [cmdgen.MibVariable(x,) for x in v.interface_mibs]
        ...
        for interface in interface_to_ipv4:
            try:
                ...
                print(f"ValueError: for {interface}")
                pass
